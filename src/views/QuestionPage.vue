...
//handle answer choices and award points to user
...
<div v-if="question" class="flex h-full w-full flex-col items-center gap-8">
...
<!-- {{ question.question }} -->
    ...
    v-html="answer.answer"
      ...
      class="bg-green-500 flex items-center justify-center text-4xl rounded-lg text-white py-10 px-1 ">
